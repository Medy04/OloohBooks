...
export default function SettingsLocationsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold">Paramètres • Lieux</h1>
        <p className="text-sm text-neutral-500 mt-1">Gérez vos lieux de vente.</p>
        <div className="mt-3">
      ...
      <div className="rounded-lg border p-4 space-y-3">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end">
          <div className="flex-1">
            ...
            <input className="w-full rounded-md border px-3 py-2 bg-transparent" value={name} onChange={(e) => setName(e.target.value)} placeholder="Ex: Abidjan" />
          </div>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td className="p-3" colSpan={3}>Aucun lieu.</td></tr>
            ) : (
              items.map((it) => (
